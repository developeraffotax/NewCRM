...
import { FaCirclePlay, FaRegUser } from "react-icons/fa6";
      ...
      <div className="w-full flex flex-col gap-3">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-[17px] font-medium text-gray-800">
            ...
            >
              {play ? (
                <IoStopCircle className="h-6 w-6 text-red-600 animate-pulse" />
              ) : (
                <FaCirclePlay className="h-6 w-6 text-sky-600 " />
              )}
            </span>
          </span>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-[17px] font-medium text-gray-800 relative">
